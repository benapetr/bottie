/****************************************************************************
** Meta object code from reading C++ file 'networkserver.hpp'
**
...
#error "The header file 'networkserver.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NetworkServer_t, stringdata) + ofs \
...
const QMetaObject NetworkServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_NetworkServer.data,
